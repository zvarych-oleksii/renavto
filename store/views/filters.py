...
def models(request, brand):
    ...
    return render(request, '../templates/car_models.html', {'car_models': car_models})
def types(request, brand, model):
    part_types = Type_of_part.objects.all()
    return render(request, '../templates/part_type.html', {'part_types':part_types})
def category(request, brand, model, type):
    ...
    return render(request, '../templates/part_category.html', {'part_category':part_category})
